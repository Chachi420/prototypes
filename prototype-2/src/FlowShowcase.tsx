  ...
  return (
    <div className="flex flex-col items-center gap-2 flex-shrink-0">
      ...
      <div
        ...
        style={{ width: outerW, height: outerH, border: '1px solid rgba(255,255,255,0.08)' }}
      >
        <div
        ...
        <div className="absolute inset-0 bg-[#0A1628]/0 group-hover:bg-[#0A1628]/20 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100 z-20">
          <span className="text-white text-xs font-bold px-4 py-2 rounded-full shadow-xl" style={{ background: '#B8963E' }}>
            Open →
          </span>
        </div>
      </div>
...
function Arrow() {
  return (
    <div className="flex-shrink-0 flex items-center" style={{ marginTop: OUTER_H.mobile / 2 - 8 }}>
      <svg width="36" height="16" viewBox="0 0 36 16" fill="none">
        <path d="M0 8H32M32 8L26 2M32 8L26 14" stroke="#B8963E" strokeOpacity="0.6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  );
}
...
function DesktopArrow() {
  return (
    <div className="flex-shrink-0 flex items-center" style={{ marginTop: OUTER_H.desktop / 2 - 8 }}>
      <svg width="36" height="16" viewBox="0 0 36 16" fill="none">
        <path d="M0 8H32M32 8L26 2M32 8L26 14" stroke="#B8963E" strokeOpacity="0.6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span
              ...
              style={{ background: 'rgba(184,150,62,0.15)', color: '#B8963E', border: '1px solid rgba(184,150,62,0.3)' }}
            >
              Agentic AI · Travel & Hospitality
            </span>
            <span className="text-white/30 text-[11px]">Prototype · 10 Screens</span>
          </div>
      ...
      <div className="px-8 py-8 space-y-10">
        ...
        <section>
          ...
          <div className="flex items-start gap-3 min-w-max pb-2">
            ...
            <Arrow />
            <ScreenFrame config={{ Component: S3_IssueDescription, route: '/describe', label: 'Describe Issue', step: 3, type: 'mobile', description: 'Dynamic chips + severity badge' }} />
            <Arrow />
            <ScreenFrame config={{ Component: S4_Tracking, route: '/tracking', label: 'Live Tracking', step: 4, type: 'mobile', description: 'Real-time progress · 2-stage advance' }} />
            <Arrow />
            <ScreenFrame config={{ Component: S5_Resolution, route: '/resolved', label: 'Resolved', step: 5, type: 'mobile', description: 'Rating + loyalty points' }} />
          </div>
        </section>
        ...
        >
          ...
          <p className="text-[#B8963E]/60 text-xs">
            ...
            {' '}Screen 4 → "View Agent Activity" jumps to Screen 6 &nbsp;·&nbsp;
            Screen 8 → "Mark Resolved" → Screen 10 (Job Completion) → Screen 5
          </p>
        </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-5">
            ...
            <div className="flex-1 h-px" style={{ background: 'rgba(255,255,255,0.07)' }} />
            <span className="text-white/25 text-xs">Screens 6 – 8, 10</span>
          </div>
          <div className="flex items-start gap-3 min-w-max pb-2">
            <ScreenFrame config={{ Component: S6_AgentTriage, route: '/agent', label: 'Agent Console', step: 6, type: 'desktop', description: 'Sequential reasoning → work order + ETA' }} />
            <DesktopArrow />
            <ScreenFrame config={{ Component: S7_WorkOrder, route: '/workorder', label: 'Work Order', step: 7, type: 'medium', description: 'Auto-generated · activity log' }} />
            <DesktopArrow />
            <ScreenFrame config={{ Component: S8_Technician, route: '/technician', label: 'Technician App', step: 8, type: 'mobile', description: 'Accept · En Route · In Progress · Resolve' }} />
            <Arrow />
            <ScreenFrame config={{ Component: S10_JobComplete, route: '/jobcomplete', label: 'Job Complete', step: 10, type: 'mobile', description: 'Manager acknowledgement + close' }} />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="min-w-max pb-2">
            <ScreenFrame config={{ Component: S9_Dashboard, route: '/dashboard', label: 'Fleet Overview', step: 9, type: 'desktop', description: 'Live SLA breach · Reassign modal · Filter chips · KPI trends' }} />
          </div>
        </section>
